...
import com.example.cloudanttest.view.TodoActivity;
...
public class TasksModel {
    ...
    private static final String DOCUMENT_STORE_DIR = "db_housing";
    private static final String DOCUMENT_STORE_NAME = "db_housing";
