...
import com.example.cloudanttest.adapter.TaskAdapter;
...
public class TodoActivity extends ListActivity
    ...
    public static final String SETTINGS_CLOUDANT_API_KEY = "pref_key_api_key";
    public static final String SETTINGS_CLOUDANT_API_SECRET = "pref_key_api_password";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toolbar toolbar = (Toolbar) findViewById(R.id.toolBar);
        if (getActionBar() != null) {
            getActionBar().setTitle("Main Page");
        }
    ...
    private void createNewTask(int desc) {
    ...
    private void toggleTaskCompleteAt(int position) {
        try {
            ...
            t.setSquare_feet(t.getSquare_feet());
        ...
        DialogInterface.OnClickListener positiveClick = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                if (description.getText().length() > 0) {
                    createNewTask(Integer.parseInt(String.valueOf(description.getText())));
